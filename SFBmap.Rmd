...
my_packages <- c("renv", "easypackages",  "here", "ggthemes", "gridExtra", "tidyverse", "lubridate", "patchwork", "tinytex", "bookdown", "ggpubr", "wesanderson", "pals", "ggridges", "hrbrthemes", "viridis", "ggrepel", "data.table")
...
#  AIzaSyA-2uPuG1Jp1VdShgPKDjdXkyA74zgvoss
...
#Set your API Key
ggmap::register_google(key = "AIzaSyA-2uPuG1Jp1VdShgPKDjdXkyA74zgvoss")
```
...
rtc <-
  ggmap(
    get_map(
      location = c(lon = -122.45238139343634, lat = 37.89121120657544),
      source = "google",
      zoom = 15,
      scale = 1 ,
      size = c(640, 640),
...
rtc2 <- rtc + geom_point(aes(x = long, y = lat, color = site_type2),
                         data = sites,
                         size = 1) +
